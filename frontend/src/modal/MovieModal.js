...
const noPosterImg =
  "https://upload.wikimedia.org/wikipedia/commons/2/28/Question_mark_white.png";
      ...
      >
        ...
        >
          <CardMedia
            ...
            height="500"
            image={
              detailedMovieResult["Poster"] !== "N/A"
                ? detailedMovieResult["Poster"]
                : noPosterImg
            }
          />
          <CardContent>
            ...
            <Typography gutterBottom variant="h5" component="div">
              {detailedMovieResult["Title"] +
                " (" +
                detailedMovieResult["Year"] +
                ")"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {detailedMovieResult["Genre"] +
                " | " +
                detailedMovieResult["Runtime"] +
                " | " +
                detailedMovieResult["Rated"]}
            </Typography>
            <Typography variant="body2" color="text.secondary">
            ...
            <Rating
              name="IMDB Rating"
              value={Number(detailedMovieResult["imdbRating"]) / 2}
              precision={0.5}
              readOnly
            />
          </CardContent>
              ...
              <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent>
                  ...
                  {typeof detailedMovieResult["dddURL"] !== "undefined" && (
                    <Typography variant="body2" color="text.secondary">
                      <a
                        href={detailedMovieResult["dddURL"]}
                        target="_blank"
                        rel="noreferrer"
                      >
                  ...
                  <List>
                    {typeof detailedMovieResult["dddWarnings"] !==
                      "undefined" &&
                      detailedMovieResult["dddWarnings"] !== null &&
                      detailedMovieResult["dddWarnings"].length !== 0 &&
                      detailedMovieResult["dddWarnings"].map(
                        (warning, index) => (
                          <ListItem key={index}>
                            <Typography variant="body2" color="text.secondary">
                              {warning.charAt(0).toUpperCase() +
                                warning.slice(1)}
                            </Typography>
                          </ListItem>
                        )
